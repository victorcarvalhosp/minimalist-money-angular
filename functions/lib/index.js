...
const ofx_js_1 = require("ofx-js/ofx.js");
...
exports.getOfxData = functions.https.onRequest((request, response) => __awaiter(this, void 0, void 0, function* () {
    const ofxString = 'OFXHEADER:100' +
        'DATA:OFXSGML' +
        'VERSION:102' +
        'SECURITY:NONE' +
        'ENCODING:USASCII' +
        ...
        '</BANKMSGSRSV1>' +
        '</OFX>';
    ofx_js_1.parse(ofxString).then(ofxData => {
